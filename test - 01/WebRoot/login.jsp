...
<div class="curPos">
	<span>当前位置</span><i class="icon-0240"></i><a href="">用户登录</a>
</div>
					...
					<div class="aui-form-content-item">
						<form action="LoginServlet"  method="POST">
							<div class="aui-form-list">
								<input type="text" class="aui-input" id="phone_number" name="phone_number" placeholder="请输入手机号" data-required="required" autocomplete="off">
							</div>
							<div class="aui-form-list">
								<input type="password" class="aui-input" id="password" name="password" placeholder="请输入密码" data-required="required" autocomplete="off">
							</div>
                            <div class="aui-form-list">
								<input type="text" class="aui-input" name="code" placeholder="输入验证码" data-required="required" autocomplete="off">
								<a href="#" class="aui-child2 aui-child-img">
